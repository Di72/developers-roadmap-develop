...
* Что такое callback (функция обратного вызова)? Когда они обычно применяются? функция которая выполнится по завершению действия / на асинх действиях
...
* Что такое частичное применение? Выполнение функции с меньшим числом аргументов без ошибок.
